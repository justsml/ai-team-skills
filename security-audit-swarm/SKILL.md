...
When scoping files or running analysis, **always exclude** these directories. They contain tool output, generated artifacts, or config — not source code under audit.
